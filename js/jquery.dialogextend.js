  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    collapse: function() {
      ...
      $(this.element[0]).dialog("option", {
        ...
        "height": newHeight,
        "maxHeight": newHeight
      }).live('dialogclose', this._collapse_restore).hide().dialog("widget").find(".ui-dialog-buttonpane:visible").hide().end().find(".ui-dialog-titlebar").css("white-space", "nowrap").end().find(".ui-dialog-content");
    ...
    _restore_collapsed: function() {
      ...
      }).live('dialogclose', this._collapse_restore);
    },
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    minimize: function() {
      ...
      $(this.element[0]).dialog("option", {
        ...
        "height": newHeight,
        "width": newWidth
      }).live('dialogclose', this._minimize_removeOverlay).dialog("widget").css("position", "static").appendTo(overlay).find(".ui-dialog-content").dialog("widget").find(".ui-dialog-titlebar").each(function() {
    ...
    _restore_minimized: function() {
      ...
      }).live('dialogclose', this._minimize_removeOverlay);
      if ($(this.element[0]).dialog("option", "draggable")) {
