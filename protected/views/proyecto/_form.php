...
?>
<select id="Proyecto_est_pro" name="Proyecto[est_pro]" style="width:220px;">
...
<?php echo $form->textArea($model,'obs_pro',array('style'=>'max-width: 550px; min-width: 550px; width: 550px; max-height: 50px; min-height: 40px;  height: 30px;', 'placeholder'=>'Ingrese texto aqui...')); ?>
