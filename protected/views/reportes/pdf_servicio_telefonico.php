...
$dataProvider = Reportes::consolidado_servicio_telefonico();
...
$total1=0;
    ...
    <td align="center"><b>CONSOLIDADO DE FAMILIAS CON TELÉFONO FIJO</b></td>
    </tr></table>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Consolidado_Servicio_telefonico.pdf','I');
