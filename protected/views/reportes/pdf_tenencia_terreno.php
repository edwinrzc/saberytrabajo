...
$dataProvider = Reportes::consolidado_tenencia_terreno();
...
$total1=0;
    ...
    <td align="center"><b>CONSOLIDADO TENENCIA DE TERRENO</b></td>
    </tr></table>
    ...
    <br>
        <table  align="center" width="80%" border="1" style="border-collapse: collapse">
            <tr  style="background-color:#F10E1D;">
                ...
                <th  width="50px" >&nbsp;PROPIO</th>
                <th  width="50px" >&nbsp;EJIDO-MUNICIPAL</th>
         ...
         while($i<$val){
            $total+=$data[$i]["propio"];
            $total1+=$data[$i]["municipal"];
$html.='
            <tr>
                <td>&nbsp;'.$data[$i]["estado"].'</td>
                <td align="center" width="50px" >&nbsp;'.$data[$i]["propio"].'</td>
                <td align="center" width="50px" >&nbsp;'.$data[$i]["municipal"].'</td>
            ';
...
$mpdf->WriteHTML($html);
$mpdf->Output('Consolidado_Tenencia_terreno.pdf','I');
