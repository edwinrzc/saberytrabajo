...
$dataProvider = Reportes::consolidado_servicio_agua();
...
$total1=0;
    ...
    <td align="center"><b>CONSOLIDADO DE FAMILIAS CON AGUAS BLANCAS</b></td>
    </tr></table>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Consolidado_Servicio_agua.pdf','I');
