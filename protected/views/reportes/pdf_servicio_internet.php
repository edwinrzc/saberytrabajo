...
$dataProvider = Reportes::consolidado_servicio_internet();
...
$total1=0;
    ...
    <td align="center"><b>CONSOLIDADO DE FAMILIAS CON INTERNET</b></td>
    </tr></table>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Consolidado_Servicio_internet.pdf','I');
