...
$dataProvider = Reportes::consolidado_servicio_electrico();
...
$total1=0;
    ...
    <td align="center"><b>CONSOLIDADO DE FAMILIAS CON ELECTRICIDAD</b></td>
    </tr></table>
...
$mpdf->WriteHTML($html);
$mpdf->Output('Consolidado_Servicio_electrico.pdf','I');
