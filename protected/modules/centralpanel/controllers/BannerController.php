...
class BannerController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Banner']))
		{
			...
			$path_picture = Yii::app()->getBasePath()."/../images/uploads/";
        ////////////////////////////////////////////////////////////////////
            ...
            if(!empty($uploadedFile))  // check if uploaded file is set or not
            {
                ...
                $result = $uploadedFile->saveAs($path_picture.$fileName);
                //die($path_picture);
                $model->img_ban= $fileName;
            }
        ////////////////////////////////////////////////////////////////////
			if($model->save())
				$this->redirect(array('view','id'=>$model->cod_ban));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Banner']))
		{
			...
			$_POST['Banner']['imagen'] = $model->img_ban;
			$model->attributes=$_POST['Banner'];
			...
			if($model->save())
			{
				...
				if(!empty($uploadedFile))  // checkeamos si el archivo subido esta seteado o no
				{
					...
					$uploadedFile->saveAs(Yii::app()->getBasePath()."/../images/uploads/".$model->img_ban);
				}
			}
				$this->redirect(array('view','id'=>$model->cod_ban));
		}
