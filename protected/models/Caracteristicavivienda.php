...
class Caracteristicavivienda extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'pre2_car_viv' => 'Condiciones de la vivienda',
			'pre3_car_viv' => 'Cual es la tenencia del terreno',
			'pre4_car_viv' => 'En que zona est&aacute; ubicada',
			'pre5_car_viv' => 'Qu&eacute; caracter&iacute;stica tiene la zona de la ubicaci&oacute;n de la vivienda',
			'pre6_car_viv' => 'De qu&eacute; manera llega a  la vivienda',
			'pre7_car_viv' => 'Materiales predominantes en las paredes internas',
			'pre8_car_viv' => 'Cu&aacute;l es material predominante en el techo',
			'pre9_car_viv' => 'Cu&aacute;l es material predominante del piso',
			'pre10_car_viv' => 'C&oacute;mo se distribuyen para dormir en las habitaciones o espacios de la vivienda',
			'pre11_car_viv' => 'Cu&aacute;ntos Ba&ntilde;os tiene la vivienda',
			'pre12_car_viv' => 'Cu&aacute;ntos Dormitorios tiene la vivienda',
			...
			'pre16_car_viv' => 'Qu&eacute; utilizan para almacenar el Agua',
			'pre17_car_viv' => 'C&oacute;mo est&aacute;n Distribuidos el o los Ba&ntilde;os con los que cuenta la Vivienda',
			'pre18_car_viv' => 'Donde est&aacute; ubicado el o los Ba&ntilde;os o Letrinas de la Vivienda',
			'pre19_car_viv' => 'A d&oacute;nde va el Agua de Desecho de la Poceta',
			'pre20_car_viv' => 'A d&oacute;nde va el Agua de Desecho del Fregadero, Ducha, Batea y Lavamanos',
			'pre21_car_viv' => 'La Vivienda cuenta con Servicio El&eacute;ctrico',
			'pre22_car_viv' => 'La Vivienda cuenta con Servicio Telef&eacute;nico Fijo',
			'pre23_car_viv' => 'La Vivienda cuenta con Servicio de Internet',
			'pre24_car_viv' => 'Centros de Educaci&oacute;n Inicial',
			'pre25_car_viv' => 'Centros de Educaci&oacute;n Primaria',
			'pre26_car_viv' => 'Centros de Educaci&oacute;n B&aacute;sica/Diversificada',
			'pre27_car_viv' => 'Centros de Educaci&oacute;n Superior',
			'pre28_car_viv' => 'Centros de Atenci&oacute;n Primaria',
			'pre29_car_viv' => 'Centros de Diagn&oacute;stico Integral',
			'pre30_car_viv' => 'Centros Hospitalarios',
			'pre31_car_viv' => 'Centros de Salud/Cl&oacute;nicas Privadas',
			'pre32_car_viv' => 'Medio de Transporte predominante',
			'pre33_car_viv' => 'Exposici&oacute;n a Factores de Riesgo Ambiental',
			'cod_edo'=>'Estado',
			'cod_mun'=>'Municipio',
			'cod_par'=>'Parroquia',
		);
