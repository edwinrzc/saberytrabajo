...
class Datosencuestado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
				array('cod_par,pri_nom_dp_enc, pri_ape_dp_enc, nac_dp_enc, ced_dp_enc', 'required'),
				...
				array('ced_dp_enc', 'unique','message' => 'Esta cédula ya existe en el Sistema'),
				array('mail_dp_enc', 'email'), 
	...
	public function attributeLabels()
	{
		return array(
			...
			'cod_mun' => 'Municipio',
			'cod_par' => 'Parroquia',
			'dir_com_dp_enc' => 'Direcci&oacute;n Completa',
			'sec_dp_enc' => 'Sector',
			...
			'mail_dp_enc' => 'Correo Electr&oacute;nico',
			'tel_hab_dp_enc' => 'Tel. Habitaci&oacute;n',
			'tel_cel_dp_enc' => 'Celular',
			'est_act_dp_enc' => 'Estudia Actualmente',
			'tip_ins_dp_enc' => 'Tipo de Instituci&oacute;n',
			'cod_mot_est' => 'Motivo de no Estudio',
			'cod_niv_ins' => 'Nivel de Instrucci&oacute;n',
			'tip_per_dp_enc' => 'Tipo Persona Encuestada',
			'cod_est_per_dp_enc' => 'Cod Est Per Dp Enc',
			'fec_reg_dp_enc' => 'Fecha de Registro',
			'cod_car_est' => 'Profesi&oacute;n',
			'ult_gra_cur_dp_enc' => 'Ultimo A&ntilde;o Cursado',
			...
			'org_soc_dp_enc' => 'Pertenece a una Organizaci&oacute;n',
			'cod_org_soc' => 'Organizacion Social',
			'mis_soc_dp_enc' => 'Pertenece a una Misi&oacute;n',
