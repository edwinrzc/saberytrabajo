...
class Condicionsalud extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'cod_dp_enc' => 'Codigo',
			'tie_tip_dis_con_sal' => '&iquest;Tiene algun tipo de discapacidad?',
			'tip_dis_con_sal' => 'Tipos de discapacidad',
			'tie_adi_con_sal' => '&iquest;Tiene alguna Adicci&oacute;n y/o Vicio?',
			'tip_adi_con_sal' => 'Tipo de Adicci&oacute;n',
			'otr_adi_con_sal' => 'Otra Adicci&oacute;n',
			'pad_enf_con_sal' => '&iquest;Padece de alguna enfermedad?',
			'rec_tra_con_sal' => '&iquest;Recibe alg&uacute;n tratamiento?',
			...
			'req_ayu_tec_con_sal' => 'Requiere ayuda t&eacute;cnica',
